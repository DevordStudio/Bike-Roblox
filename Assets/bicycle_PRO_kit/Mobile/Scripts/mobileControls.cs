...
public class mobileControls : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler {//need that for mobile controls
	...
	public Image joystickImg; //"picture" of stick itself
	public Image joystickImgLeft;//"picture" of stick itself for joyLeft
	public Vector3 inputVector; //this will be translated to bike script for bike accelerate/stop and leaning
	public Vector3 inputVectorLeft;//this will be translated to bike script for pilot's mass shift
	...
	public controlHub outsideControls;// making a link to corresponding bike's script
